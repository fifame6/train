package com.fifame.train.${module}.service;
...
import com.fifame.train.${module}.domain.${Domain};
import com.fifame.train.${module}.domain.${Domain}Example;
import com.fifame.train.${module}.mapper.${Domain}Mapper;
